...
@section('contenido')
<form method="POST" action="{{ route('admin.laboratorio.store') }}">
    @csrf
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="text" id="tipo_trabajo" name="tipo_trabajo" class="form-control @error('tipo_trabajo') is-invalid @enderror"
                               value="{{ old('tipo_trabajo') }}" list="lista-trabajos-frecuentes" placeholder="Ej: Corona Zirconia Monolítica" required>
                    ...
                    <div class="row">
                        <div class="col-md-7 mb-3">
                            ...
                            <input type="text" id="piezas_dentales" name="piezas_dentales" class="form-control font-monospace @error('piezas_dentales') is-invalid @enderror"
                                   value="{{ old('piezas_dentales') }}" placeholder="Ej: 11, 12, 21">
                            ...
                            <div class="mt-2 p-2 border rounded bg-body-tertiary">
                                ...
                                <div class="d-flex flex-wrap gap-1" id="fdi-chips">
                                    @foreach (['11','12','13','14','15','16','17','21','22','23','24','25','26','27','31','32','33','34','35','36','37','41','42','43','44','45','46','47'] as $pieza)
                                        <button type="button" class="btn btn-sm btn-outline-secondary py-0 px-1 font-monospace fdi-btn" data-pieza="{{ $pieza }}" style="font-size: 0.75rem;">
                                            {{ $pieza }}
                                        </button>
                                    @endforeach
                                </div>
                        ...
                        <div class="col-md-5 mb-3">
                            ...
                            <select id="color_vita" name="color_vita" class="form-select @error('color_vita') is-invalid @enderror">
                                ...
                                @foreach ($coloresVita as $color)
                                    <option value="{{ $color }}" @selected(old('color_vita') === $color)>{{ $color }}</option>
                                @endforeach
                            </select>
                    ...
                    <div class="mb-3">
                        ...
                        <select id="tratamiento_id" name="tratamiento_id" class="form-select @error('tratamiento_id') is-invalid @enderror">
                            ...
                            @foreach ($tratamientos as $tr)
                                <option value="{{ $tr->id }}" @selected(old('tratamiento_id') == $tr->id)>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea id="notas_tecnicas" name="notas_tecnicas" class="form-control @error('notas_tecnicas') is-invalid @enderror" rows="5"
                                  placeholder="Indicaciones de oclusión, tipo de margen (chamfer, hombro cerámico), anatomía oclusal, espacio interoclusal, pónticos ovalados, etc.">{{ old('notas_tecnicas') }}</textarea>
        ...
        <div class="col-lg-4">
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <x-selector-paciente nombre="paciente_id" :seleccionado="$paciente?->id ?? old('paciente_id')" requerido />
                        @error('paciente_id')
                    ...
                    <div class="mb-3">
                        ...
                        <select id="laboratorio_id" name="laboratorio_id" class="form-select @error('laboratorio_id') is-invalid @enderror" required>
                            ...
                            @foreach ($laboratorios as $lab)
                                <option value="{{ $lab->id }}" @selected(old('laboratorio_id') == $lab->id)>
            ...
            <div class="card mb-3">
                ...
                <div class="card-body">
                    <div class="mb-3">
                        ...
                        <input type="date" id="fecha_envio" name="fecha_envio" class="form-control @error('fecha_envio') is-invalid @enderror"
                               value="{{ old('fecha_envio', now()->toDateString()) }}" required>
                        @error('fecha_envio')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="mb-3">
                        ...
                        <input type="date" id="fecha_prometida" name="fecha_prometida" class="form-control @error('fecha_prometida') is-invalid @enderror"
                               value="{{ old('fecha_prometida', now()->addDays(7)->toDateString()) }}" required>
                        <small class="form-hint">Fecha en la que el laboratorio debe retornar la prótesis.</small>
                    ...
                    <div class="row">
                        <div class="col-6 mb-3">
                            ...
                            <input type="number" step="0.01" min="0" id="costo_laboratorio" name="costo_laboratorio"
                                   class="form-control @error('costo_laboratorio') is-invalid @enderror" value="{{ old('costo_laboratorio') }}" placeholder="0.00">
                        ...
                        <div class="col-6 mb-3">
                            ...
                            <input type="number" step="0.01" min="0" id="precio_paciente" name="precio_paciente"
                                   class="form-control @error('precio_paciente') is-invalid @enderror" value="{{ old('precio_paciente') }}" placeholder="0.00">
                    ...
                    <div class="mb-3">
                        <label class="form-label required" for="estado">Estado inicial</label>
                        <select id="estado" name="estado" class="form-select @error('estado') is-invalid @enderror" required>
                            @foreach ($estados as $clave => $meta)
                                <option value="{{ $clave }}" @selected(old('estado', 'PENDIENTE') === $clave)>
                ...
                <div class="card-footer d-flex gap-2">
                    <a href="{{ route('admin.laboratorio.index') }}" class="btn btn-link">Cancelar</a>
