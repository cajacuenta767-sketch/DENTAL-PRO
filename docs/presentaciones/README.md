...
- `index.html` — página responsive con las 9 piezas. Cada pieza escala con el ancho
  ...
  superior se cambia marca, sitio web, WhatsApp y formato (1:1, 4:5 y 9:16); los
...
node docs/presentaciones/exportar.mjs --marca "Mi Clínica" --web "WWW.MICLINICA.COM" --wa "+57 300 000 0000"
```
