...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Las siguientes líneas contienen los mensajes de error predeterminados que
    | utiliza la clase validadora. Algunas reglas tienen varias versiones, como
    | las reglas de tamaño. Puedes ajustar cada uno de estos mensajes aquí.
    |
    */
    ...
    'password' => [
        ...
        'uncompromised' => 'El valor de :attribute ha aparecido en una filtración de datos. Por favor, elige otro :attribute.',
    ],
    ...
    |--------------------------------------------------------------------------
    |
    | Aquí puedes definir mensajes de validación personalizados para atributos
    | usando la convención "atributo.regla" para nombrar las líneas. Esto permite
    | indicar rápidamente un mensaje específico para una regla de un atributo.
    |
    */
    ...
    | algo más legible, como "Correo electrónico" en lugar de "email". Esto
    | simplemente ayuda a que los mensajes sean más expresivos.
    |
    */
