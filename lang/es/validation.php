...
return [
    ...
    |--------------------------------------------------------------------------
    |
    | Traducción al español de los mensajes por defecto del validador. La
    | aplicación corre con APP_LOCALE=es, así que sin este archivo Laravel
    | mostraría la clave cruda («validation.required») en cada formulario.
    |
    */
    ...
    'doesnt_contain' => 'El campo :attribute no puede contener ninguno de los siguientes valores: :values.',
    ...
    'password' => [
        ...
        'uncompromised' => 'El campo :attribute apareció en una filtración de datos. Elige otro valor.',
    ],
    ...
    */
    ...
    |--------------------------------------------------------------------------
    |
    | Se usan para reemplazar :attribute por un nombre que el usuario entienda.
    | Cubren los campos de los formularios del panel y del sitio público.
    |
    */
    ...
    'attributes' => [
        ...
        'contenido' => 'contenido',
        'hallazgos' => 'hallazgos',
        'piezas' => 'piezas dentales',
        'piezas_referidas' => 'piezas referidas',
        'odontograma_id' => 'odontograma',
        ...
        'detalles' => 'detalle',
        'detalles.*.tratamiento_id' => 'tratamiento del detalle',
        ...
        'detalles.*.pieza_dental' => 'pieza dental del detalle',
        'detalles.*.cara' => 'cara del detalle',

        // Facturación
        'nit' => 'NIT',
        'receptor_nombre' => 'nombre del receptor',
        'receptor_documento' => 'documento del receptor',
        'receptor_direccion' => 'dirección del receptor',
        'receptor_email' => 'correo del receptor',

        // Ajustes de la clínica
        'divisa' => 'divisa',
        'simbolo_divisa' => 'símbolo de la divisa',
        'logo_archivo' => 'logotipo',
        'minutos_intervalo_cita' => 'intervalo de cita',
        'horas_recordatorio' => 'horas de recordatorio',
        'terminos_recibo' => 'términos del recibo',
        'reservas_minimo_horas' => 'anticipación mínima',
        'reservas_anticipacion_dias' => 'anticipación máxima',
        'reservas_mensaje' => 'mensaje de reservas',
    ],
